    ...
    return (
        <main className={style.container}>
            ...
            <div className={style.main1}>
                <Link to="/Fif" className={style.h1}>FIF GROUP</Link>
            </div>
                ...
                <div className={style.kolom}>
                    <div className={style.card}>
                        ...
                        <div className={style.text}>
                            ...
                            <h2 className={style.h2}>FIF GROUP</h2>
                        </div>
                    </div>
                    ...
                    <div className={style.card}>
                        ...
                        <div className={style.text}>
                            ...
                            <h2 className={style.h2}>Media Placement TV</h2>
                        </div>
                    </div>
                    ...
                    <div className={style.card}>
                        ...
                        <div className={style.text}>
                            ...
                            <Link to="/study-case" className={`${style.h2} ${style.link}`}>Media</Link>
                        </div>
                    </div>
                </div>
